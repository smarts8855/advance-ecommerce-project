            ...
            <input type="hidden" name="old_image" value="{{ $editdata->profile_photo_path }}">
             <div class="row">
               ...
               <div class="row">
                  ...
                  <div class="col-md-6">
                  <img id="showImage" src="{{ (!empty($admindata->profile_photo_path))? url('upload/admin_images/'.$admindata->profile_photo_path):url('upload/no_image.jpg') }}" width="100" height="100" alt="">
                  </div><!-- end col md 6 -->
               </div> <!-- end row -->
