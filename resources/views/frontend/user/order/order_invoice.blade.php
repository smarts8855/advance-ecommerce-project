  ...
  <table width="100%" style="background: #F7F7F7; padding:0 20px 0 20px;">
    <tr>
        <td valign="top">
          ...
          <h2 style="color: green; font-size: 26px;"><strong>T-SmartShop</strong></h2>
        </td>
        <td align="right">
            <pre class="font" >
               T-SmartShop Head Office
               Olaoyea64@gmail.com<br>
               Mob: 08106972881<br>
               472, Lagos-Abeokuta Exp Genera
...
<h3>Products</h3>
  ...
  <table width="100%">
    ...
    @foreach($orderItem as $item)
      <tr class="font">
        <td align="center">
        <img src="{{ asset($item->product->product_thambnail) }}" alt="" height="60px" width="60px">
        </td>
