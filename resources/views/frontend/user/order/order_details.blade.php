...
<div class="body-content">
    <div class="container">
        ...
        <div class="col-md-5">
            <div class="card">
                <div class="card-header"><h4>Order Details <span class="text-danger"> Invoice : {{ $order->invoice_no }}</span></h4>
                </div>
                ...
                <table class="table">
                    <tbody>
                        ...
                        <td class="col-md-1">
                           ...
                           <strong>
                            <span class="badge badge-pill badge-success" style="background: #FF0000;">No File</span>
                           </strong>
                           @elseif($order->status == 'confirm')
                           <a target="_blank" href="{{ asset('upload/pdf/'.$file->digital_file) }}">
                           <strong>
                            <span class="badge badge-pill badge-success" style="background: #418DB9#FF0000;">Download Read</span>
                           </strong>
                           </a>
