      ...
      <div class="modal-body">
        <div class="row">
          ...
          <ul class="list-group">
            ...
            <li class="list-group-item">Stock: <span class="badge badge-pill badge-success" id="available" style="background-color: green; color: white;"></span>
            <span class="badge badge-pill badge-danger" id="stockout" style="background-color: red; color: white;"></span>
          </li>
          </ul>
          </div><!-- // end col md 4 -->
          ...
          <button class="btn btn-primary" type="submit" onclick="addToCart()">Add to Card</button>
          </div><!-- // end col md 4 -->
                ...
                <div class="cart-item product-summary">
                  <div class="row">
                    ...
                    <div class="col-xs-7">
                      ...
                      <div class="price">${value.price * value.qty} 
                      (${value.qty})</div>
                    </div>
  ...
  function cart(){
    $.ajax({
      ...
      success:function(response){
        ...
        $.each(response.carts, function(key,value){
          rows +=`<tr>
					<td class="col-md-2"><img src="/${value.options.image}" alt="imga" style="width:60px; heigth:60px"></td>
					<td class="col-md-2">
