	...
	<div class="row">
		...
		<div class="quantity-container info-container">
			<div class="row">
				...
				<input class="form-control" type="hidden" id="product_id" value="{{ $product->id }}" min="1">
		...
		<div class="addthis_inline_share_toolbox_mw86"></div>
							...
							<div class="tab-content">
								...
								<div id="description" class="tab-pane in active">
									<div class="product-tab">
										<p class="text">@if(session()->get('language') == 'hindi') {!! $product->long_descp_hin !!} @else   {!! $product->long_descp_en !!} @endif</p>
									</div>	
								</div><!-- /.tab-pane -->
...
<div class="product-reviews">
	...
	<div class="reviews">
		...
		<div class="row">
			<div class="col-md-6">
			<img  style="border-radius: 50%; "  src="{{ (!empty($item->user->profile_photo_path))? url('upload/user_images/'.$item->user->profile_photo_path):url('upload/no_image.jpg') }}" alt="" height="40px" width="40px"> <b>{{ $item->user->name }}</b>
			...
			<div class="review-title"><span class="summary">{{ $item->summary }}</span><span class="date"><i class="fa fa-calendar"></i><span>{{ Carbon\Carbon::parse($item->created_at)->diffForHumans() }}</span></span>
		    </div>
			<div class="text">
				{{ $item->comment }}
			</div>
...
<!-- Go to www.addthis.com/dashboard to customize your tools -->
<script type="text/javascript" src="//s7.addthis.com/js/300/addthis_widget.js#pubid=ra-63b6810d326d450e"></script>
