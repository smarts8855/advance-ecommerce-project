                    ...
                    <div class="col-12">
                       ...
                       <div class="row">  <!-- start 3rd row -->
                          ...
                          <div class="form-group">
                                ...
                                <div class="controls">
                                    <input type="text" name="product_tag_en" class="form-control" value="Lorem,Ipsum,Amet" data-role="tagsinput" required="">
                       ...
                       <div class="row">  <!-- start 4th row -->
                          ...
                          <div class="form-group">
                                ...
                                <div class="controls">
                                    <input type="text" name="product_tag_hin" class="form-control" value="Lorem,Ipsum,Amet" data-role="tagsinput" required="">
                       ...
                       <div class="row">  <!-- start 5th row -->
                          ...
                          <div class="form-group">
                                ...
                                <div class="controls">
                                    <input type="text" name="product_color_en" class="form-control" value="red,black,blue" data-role="tagsinput" required="">
                    ...
                    <img src="" alt="" id="mainThmb">
                       ...
                       <div class="row">  <!-- start 7th row -->
                          ...
                          <div class="form-group">
                                ...
                                <div class="controls">
                                <textarea name="short_descp_hin" id="textarea" class="form-control" required ></textarea>                                    
                            ...
                            <div class="form-group">
                                ...
                                <div class="controls">
                                    <fieldset>
                                        ...
                                        <label for="checkbox_2">Hort Deals</label>
                                    </fieldset>
                                    <fieldset>
     ...
     if (window.File && window.FileReader && window.FileList && window.Blob) //check File API supported browser
     {
         ...
         $.each(data, function(index, file){ //loop though each file
             if(/(\.|\/)(gif|jpe?g|png)$/i.test(file.type)){ //check supported file type
                 ...
                 return function(e) {
                     var img = $('<img/>').addClass('thumb').attr('src', e.target.result) .width(40)
                 .height(40); //create image element 
