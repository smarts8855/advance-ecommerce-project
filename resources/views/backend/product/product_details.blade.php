                    ...
                    <div class="col-12">
                       ...
                       <div class="row">  <!-- start 3rd row -->
                          ...
                          <div class="form-group">
                                ...
                                <div class="controls">
                                    <input type="text" name="product_tag_en" class="form-control" value="{{ $products->product_tag_en }}" data-role="tagsinput" required="">
                       ...
                       <div class="row">  <!-- start 4th row -->
                          ...
                          <div class="form-group">
                                ...
                                <div class="controls">
                                    <input type="text" name="product_tag_hin" class="form-control" value="{{ $products->product_tag_hin }}" data-role="tagsinput" required="">
                       ...
                       <div class="row">  <!-- start 7th row -->
                          ...
                          <div class="form-group">
                                ...
                                <div class="controls">
                                <textarea name="short_descp_hin" id="textarea" class="form-control" required >
